    ...
    <div className="w-full p-3 bg-[#FDFDFD] rounded lg:h-[700px]">
      <form onSubmit={handleSubmit(onSubmit)} className="px-8 pt-6 pb-8 mb-4">
        ...
        <label className="">
          ...
          />{" "}
          <small>
            By checking this box, you agree to be added to our mailing list.
        ...
        <label className="">
          ...
          />{" "}
          <small>
            By Checking this box, you agree to our <span className="font-semibold underline text-[#126BAD]">Terms of Service</span> and 
            <span className="font-semibold underline text-[#126BAD]"> Privacy Policy</span>.
          </small>
        </label>
        ...
        <div className="mt-4">
          <button
            className={`w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ${
              !(radioChecked1 && radioChecked2) ? "cursor-not-allowed opacity-50" : ""
            }`}
            type="submit"
